                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () => ref.read(setStateProvider('reset_confirm').notifier).toggleFlag('obscurePassword', defaultValue: true),
                          ),
                          hintText: '••••••••',
                          hintStyle: TextStyle(color: isDark ? AppTheme.darkTextSecondary : Colors.grey.shade400),
                          filled: true,
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () => ref.read(setStateProvider('reset_confirm').notifier).toggleFlag('obscureConfirm', defaultValue: true),
                          ),
                          hintText: '••••••••',
                          hintStyle: TextStyle(color: isDark ? AppTheme.darkTextSecondary : Colors.grey.shade400),
                          filled: true,
